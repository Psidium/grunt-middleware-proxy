(function(){
  ...
  var DEPRECATED_HEADERS = [
    ...
    oProxyRes.headers = this._removeDeprecatedParameters(oProxyRes.headers);
  ...
  ProxyHandler.prototype._removeDeprecatedParameters = function (headers) {
    return Object.keys(headers || {})
      .filter(function (header) {
        return DEPRECATED_HEADERS.indexOf(header) == -1;
      })
